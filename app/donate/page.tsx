...
export const metadata: Metadata = {
  title: "Donate — ESSA",
  description: "Support ESSA's mission to empower Ethiopian youth through street sports.",
};
